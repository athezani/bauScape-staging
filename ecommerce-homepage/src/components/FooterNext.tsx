...
export const FooterNext = forwardRef<HTMLElement>((props, ref) => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/esperienze" className="hover:opacity-70 transition-opacity" style={{ color: 'var(--text-gray)' }}>
                  Esperienze
                </Link>
              </li>
              <li>
                <Link href="/viaggi" className="hover:opacity-70 transition-opacity" style={{ color: 'var(--text-gray)' }}>
                  Viaggi
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/contatti" className="hover:opacity-70 transition-opacity" style={{ color: 'var(--text-gray)' }}>
                  Contatti
                </Link>
              </li>
              <li>
...
FooterNext.displayName = 'FooterNext';
