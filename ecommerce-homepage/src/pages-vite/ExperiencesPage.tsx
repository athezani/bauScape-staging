...
export function ExperiencesPage({
  ...
  const experiences = useMemo(() => {
    const filtered = products.filter((p) => p.type === 'experience');
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        ...
        description="Scopri le migliori esperienze dog-friendly in Italia. Escursioni, attività all'aperto e avventure uniche per te e il tuo cane. Prenota la tua esperienza oggi!"
      ...
      <section className="py-12 lg:py-16 bg-gradient-to-b from-purple-50 to-white">
        <div className="max-w-[1200px] mx-auto px-4">
          <h1 className="mb-4 text-center" style={{ color: 'var(--primary-purple)' }}>
            Esperienze Dog-Friendly
          </h1>
          <p className="text-center max-w-2xl mx-auto" style={{ color: 'var(--text-gray)' }}>
            Scopri tutte le nostre esperienze pensate per te e il tuo amico a quattro zampe
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto px-4">
          <div className="mb-6 space-y-2">
            <p style={{ color: 'var(--text-gray)' }}>
              {experiences.length} esperienze disponibili
            </p>
            {loading && (
              <p className="text-sm" style={{ color: 'var(--text-gray)' }}>
                Caricamento delle esperienze...
              </p>
            )}
            {error && (
