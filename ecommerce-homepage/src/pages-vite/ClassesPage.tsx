  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        ...
        description="Corsi formativi e classi per te e il tuo cane. Addestramento, educazione e attività educative per migliorare il rapporto con il tuo amico a quattro zampe."
