...
export function ContattiPage({ onNavigate }: ContattiPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        ...
        description="Contattaci per qualsiasi domanda o richiesta. Siamo qui per aiutarti a trovare l'esperienza perfetta per te e il tuo cane."
      />
      <Header 
