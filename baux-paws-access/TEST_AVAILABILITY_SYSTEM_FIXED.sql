-- ============================================
-- TEST COMPLETO SISTEMA DISPONIBILITÀ - VERSIONE CORRETTA
-- IMPORTANTE: Usa number_of_humans invece di number_of_adults per provider portal
-- ============================================
...
-- IMPORTANTE: Usa number_of_humans (non number_of_adults) per provider portal
DO $$
DECLARE
  test_slot_id UUID;
...
BEGIN
  ...
  IF test_slot_id IS NOT NULL AND test_provider_id IS NOT NULL THEN
    ...
    -- Crea booking (USA number_of_humans, NON number_of_adults!)
